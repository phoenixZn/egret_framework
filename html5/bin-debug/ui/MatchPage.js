...
var MatchPage = (function (_super) {
    __extends(MatchPage, _super);
    function MatchPage() {
        return _super.call(this) || this;
    }
    MatchPage.prototype.partAdded = function (partName, instance) {
        _super.prototype.partAdded.call(this, partName, instance);
    };
    MatchPage.prototype.childrenCreated = function () {
    ...
    MatchPage.prototype.onApply = function () {
        return __awaiter(this, void 0, void 0, function () {
            var match, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        match = GameGlobal.GameLogic.ModuleManager.GetModule(MatchModule);
                        if (!match) return [3 /*break*/, 2];
                        this.apply.enabled = false;
                        this.start.enabled = true;
                        return [4 /*yield*/, match.ApplyMatch()];
                    case 1:
                        res = _a.sent();
    ...
    MatchPage.prototype.onStart = function () {
        return __awaiter(this, void 0, void 0, function () {
            var match, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MatchPage.prototype.onApplyInfo = function (msg) {
        if (msg)
            this.count.text = msg.count.toString();
    };
    return MatchPage;
}(UIBase));
__reflect(MatchPage.prototype, "MatchPage");
;

...
declare module egret3d {
    class PostRenderBuffer {
        useDepthPass: boolean;
        useNormalPass: boolean;
        useColorPass: boolean;
        useSpecularPass: boolean;
        private debugHUD;
        constructor();
        drawRenderBuffer(time: number, delay: number, context3D: Context3DProxy, collect: EntityCollect, camera: Camera3D, backViewPort?: Rectangle): void;
    }
}
declare module egret3d {
    /**
...
declare module egret3d {
    ...
    * @includeExample texture/CheckerboardTexture.ts
    */
    class CheckerboardFloatTexture extends ITexture {
        /**
        * @language zh_CN
        * 公用棋盘格实例对象
        * @version Egret 3.0
